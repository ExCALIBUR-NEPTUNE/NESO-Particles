...
#include <neso_particles/external_interfaces/petsc/boundary_interaction/boundary_interaction_2d.hpp>

namespace NESO::Particles::PetscInterface {

ExternalCommon::BoundingBoxSharedPtr
BoundaryInteraction2D::get_bounding_box(const int index) {
...
void BoundaryInteraction2D::free() {
