#include <neso_particles/particle_sub_group/discard_sub_group_selector.hpp>

namespace NESO::Particles::ParticleSubGroupImplementation {

template DiscardSubGroupSelector::DiscardSubGroupSelector(
...
void DiscardSubGroupSelector::create(Selection *created_selection) {
  ...
  auto pr0 = sycl_target->profile_map.start_region("DiscardSubGroupSelector",
                                                   "create");
