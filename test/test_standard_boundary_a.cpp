...
TEST(CartesianTrajectoryIntersection, labels_2d) {
  ...
  lambda_do_test(0, 0.5, -1000.0);
  lambda_do_test(2, 0.5, 1000.0);
  lambda_do_test(3, -1000.0, 0.5);
  lambda_do_test(1, 1000.0, 0.5);
}

TEST(CartesianTrajectoryIntersection, shallow_intersection_2d) {

  const int ncell_x = 31;
